...
class BaseUnit extends Phaser.GameObjects.Polygon {
    constructor(scene, x, y, fillColor, bulletGroup, unitGroup, targetGroup, unitConfig, initRotationAdj = 0) {
        super(scene, x, y, unitConfig.tri, fillColor);
